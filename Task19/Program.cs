...
namespace Task19
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                new Computer(){Id=1, Name="Asus", Type="AMD", Frequency=2600, Ram=16, Hdd=512, Video=6, Cost=1750, Count=30},
                new Computer(){Id=2, Name="Lenovo", Type="Corei5", Frequency=2600, Ram=8, Hdd=512, Video=4, Cost=1500, Count=25},
                new Computer(){Id=3, Name="Asus", Type="Pentium", Frequency=4000, Ram=4, Hdd=128, Video=2, Cost=400, Count=15},
                new Computer(){Id=4, Name="Acer", Type="AMD", Frequency=1350, Ram=4, Hdd=120, Video=2, Cost=500, Count=40},
                ...
                new Computer(){Id=7, Name="HP", Type="Corei9", Frequency=2900, Ram=16, Hdd=512, Video=4, Cost=3000, Count=15},
                new Computer(){Id=8, Name="iRU", Type="AMD", Frequency=3400, Ram=8, Hdd=500, Video=6, Cost=2000, Count=35},
                new Computer(){Id=9, Name="Dell", Type="Corei7", Frequency=2500, Ram=32, Hdd=1000, Video=24, Cost=6500, Count=3},
                new Computer(){Id=10, Name="HP", Type="Corei9", Frequency=2500, Ram=16, Hdd=1000, Video=8, Cost=3500, Count=5}
            };
            ...
            Console.WriteLine("Cписок всех компьютеров, сортировка по увеличению стоимости:");
